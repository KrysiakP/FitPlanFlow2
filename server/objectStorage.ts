...
// This file provides object storage service for storing and retrieving files
...
export class ObjectStorageService {
  ...
  // Gets the ACL policy for an object entity
  async getObjectAclPolicy(objectFile: File): Promise<any> {
