...
export function TrainerSection() {
  ...
  return (
    <section id="dla-trenera" className="py-16 px-4 bg-background">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex gap-4 justify-center pt-4">
                ...
                <Button size="lg" variant="outline" onClick={handleScrollToPricing} data-testid="button-pricing">
                  Zobacz cennik
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card data-testid="card-feature-reports">
                <CardHeader>
                  ...
                  <CardDescription>
                    Podopieczni przesyłają zdjęcia postępów, pomiary (waga, obwody) 
                    i notatkę o samopoczuciu. Masz pełny obraz ich transformacji.
                  </CardDescription>
                </CardHeader>
              </Card>
          ...
          <div className="border-t pt-12">
            <div className="bg-primary/5 rounded-lg p-8 md:p-12 space-y-6">
              ...
              <div className="text-center pt-4">
                <Button onClick={handleScrollToPricing} size="lg" data-testid="button-view-all-plans">
