...
import { Check, Crown, Dumbbell, Zap, Building2, Star, ChevronDown, ChevronUp, CheckCircle2, XCircle, Loader2 } from "lucide-react";
...
export default function Pricing() {
  ...
  const { data: myReferralCode } = useQuery<{ code: string }>({
    ...
    enabled: user?.role === 'trainer' && !(user?.hasFreeAccess ?? false),
  });
