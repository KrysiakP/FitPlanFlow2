...
function RoleBadge({ role, colors }: { role: string; colors: Colors }) {
  const isTrainer = role === "trainer";
  return (
    <View style={[badgeStyles.badge, { backgroundColor: isTrainer ? colors.primary + "18" : colors.accent }]}>
      <Text style={[badgeStyles.text, { color: isTrainer ? colors.primary : colors.mutedForeground }]}>
            ...
            <View style={styles.codeCardHeader}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.codeCardDesc, { color: colors.mutedForeground }]}>
                  Udostępnij znajomym i zgarniaj darmowe dni subskrypcji
                </Text>
              </View>
            </View>
